...
history1 = model.fit(
  ...
  shuffle=True,
  epochs = 100,
  callbacks = [tf.keras.callbacks.EarlyStopping(monitor='loss', patience=4, min_delta = 0.001, restore_best_weights=True)])
...
plt.ylabel('MSE')
plt.xlabel('Epoch')
plt.savefig('Train_1_MSE_100_New_4')
plt.close()
...
plt.ylabel('Accuracy')
plt.xlabel('Epoch')
plt.savefig('Train_1_Categorical_Accuracy_100_New_4')
plt.close()
...
plt.ylabel('Accuracy')
plt.xlabel('Epoch')
plt.savefig('Train_1_Loss_100_New_4')
plt.close()
...
get_metrics(final_prediction_train, y_train, "Train Metrics***************", "Train_1_100_New_4", "Train_1_Conf_Mat_100_New_4")
get_metrics(final_prediction_test, y_test, "Test Metrics****************", "Test_1_100_New_4", "Test_1_Conf_Mat_100_New_4")
